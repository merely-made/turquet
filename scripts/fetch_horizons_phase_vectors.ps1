...
@(
    '# Turquet T4c lunar phase vectors',
    ...
    '# sampling: ten minutes before, at, and after each NASA GSFC April 2024 quarter-phase minute',
    '# reference: NASA GSFC phase2001gmt.html, 2024-04-02 03:15, 04-08 18:21, 04-15 19:13, 04-23 23:49 UT',
    '# regenerate: pwsh -File scripts/fetch_horizons_phase_vectors.ps1 > tests/vectors/lunar_phases_horizons.tsv',
